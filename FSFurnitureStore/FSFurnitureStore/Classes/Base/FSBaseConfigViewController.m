...
@interface FSBaseConfigViewController ()

@end

@implementation FSBaseConfigViewController
...
- (NSString *)token {
    if ([FSLoginManager manager].token) {
        return [FSLoginManager manager].token;
    }else {
        return @"";
    }
}
...
- (NSAttributedString *)buttonTitleForEmptyDataSet:(UIScrollView *)scrollView forState:(UIControlState)state {
    NSString *buttonTitle = @"No data, please click refresh";
